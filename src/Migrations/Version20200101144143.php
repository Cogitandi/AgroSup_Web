 ...
 */
final class Version20200101144143 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE operator (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, year_plan_id INT NOT NULL, first_name VARCHAR(30) NOT NULL, surname VARCHAR(30) NOT NULL, arimr_number VARCHAR(11) DEFAULT NULL, disable TINYINT(1) NOT NULL, INDEX IDX_D7A6A781A76ED395 (user_id), INDEX IDX_D7A6A781FA36FFE2 (year_plan_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE plant (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(20) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
